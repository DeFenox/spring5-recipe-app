package com.defenox.spring5recipeapp.bootstrap;

import com.defenox.spring5recipeapp.domain.*;
import com.defenox.spring5recipeapp.repositories.CategoryRepository;
import com.defenox.spring5recipeapp.repositories.RecipeRepository;
import com.defenox.spring5recipeapp.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        if (!tablespoonUomOptional.isPresent()) {
            throw new RuntimeException("Expected Tablespoon not found");
        }

        Optional<UnitOfMeasure> teaspoonUomOptional = unitOfMeasureRepository.findByDescription("Teaspoon");

        if (!teaspoonUomOptional.isPresent()) {
            throw new RuntimeException("Expected Teaspoon not found");
        }
        ...
        if (!cupsUomOptional.isPresent()) {
            throw new RuntimeException("Expected Cups not found");
        }
